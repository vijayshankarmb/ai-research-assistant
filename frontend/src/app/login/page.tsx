...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-md w-full space-y-8 bg-white p-6 md:p-10 rounded-xl shadow-sm border border-gray-100">
        <div>
          <h2 className="mt-2 md:mt-6 text-center text-2xl md:text-3xl font-extrabold text-gray-900">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleLogin}>
          ...
          <div className="text-center text-sm text-gray-600 mt-4">
            Don't have an account? <Link href="/signup" className="font-medium text-black hover:underline">Sign up</Link>
          </div>
        </form>
      </div>
    </div>
